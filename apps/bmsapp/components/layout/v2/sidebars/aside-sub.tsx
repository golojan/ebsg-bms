                ...
                <div className="item-wrapper mb-5">
                  <ul className="mt-2.5 flex justify-center items-center flex-col">
                    <li className="item py-[11px] px-[43px]">
                      ...
                      <ul className="sub-menu border-l border-success-100 bg-white px-5 py-2 rounded-lg shadow-lg min-w-[200px]">
                        <li>
                          <a
                            href="index-2.html"
                            className="text-md font-medium text-bgray-600 py-1.5 inline-block hover:text-bgray-800"
                          >
                            Dashboard Two
                          </a>
                        </li>
