...
import { toggleDropDown } from 'libs/ui-actions';
...
const AccessPopups = () => {
  const [dataLayoutMode, setDataLayoutMode] = useAtom(dataLayoutModeAtom);
  const toggleTheme = () => {
    setDataLayoutMode(dataLayoutMode === 'dark' ? 'light' : 'dark');
  };

  const notificationRef = React.useRef(null);
  const notificationOutRef = React.useRef(null);
  const profileBoxRef = React.useRef(null);
  const profileOutBoxRef = React.useRef(null);
  const storeRef = React.useRef(null);
  const storeOutRef = React.useRef(null);
  const messageRef = React.useRef(null);
  const messageOutRef = React.useRef(null);

  const notificationAction = (e: React.SyntheticEvent) => {
    e.preventDefault();
    toggleDropDown(notificationRef);
    toggleDropDown(notificationOutRef);
  };

  const messageAction = (e: React.SyntheticEvent) => {
    e.preventDefault();
    toggleDropDown(messageRef);
    toggleDropDown(messageOutRef);
  };

  const storeAction = (e: React.SyntheticEvent) => {
    e.preventDefault();
    toggleDropDown(storeRef);
    toggleDropDown(storeOutRef);
  };

  const profileAction = (e: React.SyntheticEvent) => {
    e.preventDefault();
    toggleDropDown(profileBoxRef);
    toggleDropDown(profileOutBoxRef);
  };
  ...
  // const dateFilterAction = (selectorRef: any) => {
  //   toggleDropDown(profileBoxRef);
  // };

  const { user, busy, logout } = useUser();
  return (
    <>
      <div className="quick-access-wrapper relative">
        <div className="flex space-x-[43px] items-center">
          <div className="xl:flex hidden space-x-5 items-center">
            <button
              type="button"
              id="theme-toggle"
              className="w-[52px] h-[52px] rounded-[12px] border border-success-300 dark:border-darkblack-400 flex justify-center items-center relative"
              onClick={toggleTheme}
            >
            ...
            <button
              ...
              className="w-[52px] h-[52px] rounded-[12px] border border-success-300 dark:border-darkblack-400 flex justify-center items-center relative"
            >
              <span className="w-3.5 h-3.5 rounded-full bg-error-300 border-2 border-white absolute -right-[5px] -top-[2px] dark:border-none" />
              <svg
            ...
            <button
              ...
              className="w-[52px] h-[52px] rounded-[12px] border border-success-300 dark:border-darkblack-400 flex justify-center items-center relative"
            >
              <span className="w-3.5 h-3.5 rounded-full bg-bgray-300 border-2 border-white absolute -right-[5px] -top-[2px] dark:bg-bgray-600 dark:border-none " />
              <svg
                className="stroke-bgray-900 dark:stroke-white"
                width={24}
                height={24}
          ...
          <div className="xl:block hidden h-[48px] w-[1px] bg-bgray-300 dark:bg-darkblack-400" />
          {/* author*/}
          <div
            onClick={(e) => {
              profileAction(e);
          ...
          >
            <div className="w-[52px] h-[52px] rounded-xl border border-bgray-300 overflow-hidden p-1">
              <StaleHolder
                busy={busy}
                width={52}
                height={52}
            ...
            <div className="2xl:block hidden">
              <div className="flex space-x-2.5 items-center">
                <StaleHolder
                  ...
                  className="dark:bg-bgray-600"
                >
                  <h3 className="text-base dark:text-white text-bgray-900 font-bold leading-[28px]">
              ...
              <StaleHolder
                ...
                className="dark:bg-bgray-600"
              >
                <p className="text-md font-medium leading-[20px] dark:text-bgray-50 text-bgray-600">
                  Role: <strong>{user?.role === 0 ? 'User' : 'Admin'}</strong>
                </p>
              </StaleHolder>
            </div>
          </div>
        </div>
        {/* notification ,message, store, profile*/}
        <div className="notification-popup-wrapper">
          <div
            ref={notificationOutRef}
            id="noti-outside"
            onClick={(e) => {
              notificationAction(e);
            }}
            className="w-full h-full fixed -left-[43px] top-0 hidden"
          />
          <div
            id="notification-box"
            ref={notificationRef}
            ...
            className="w-[400px] bg-white dark:bg-darkblack-600 absolute -left-[347px] top-[81px] rounded-lg hidden"
          >
            <div
              className="w-full pt-[66px] pb-[75px] relative"
              aria-labelledby="noti-outside"
            >
              <div className="w-full h-[66px] flex justify-between items-center absolute left-0 top-0 px-8">
              ...
              <ul className="w-full min-h-[35px] overflow-y-scroll scroll-style-1">
                {/* <li className="py-4 pl-6 pr-[50px] hover:bg-bgray-100 dark:hover:bg-darkblack-500 border-b border-bgray-200 dark:border-darkblack-400">
                  <a href="#">
                    <div className="noti-item">
                      <p className="font-medium text-sm text-bgray-600 dark:text-bgray-50 mb-1">
              ...
              <div className="w-full min-h-[15px] flex justify-between items-center absolute left-0 bottom-0 px-8">
                <div>
                  <a href="#">
        ...
        <div className="message-popup-wrapper">
          ...
          <div
            ...
            className="w-[400px] bg-white dark:bg-darkblack-600 absolute -left-[276px] top-[81px] rounded-lg hidden"
          >
            <div className="w-full pt-[66px] pb-[75px] relative">
              ...
              <div>
                <div className="flex items-center border-b border-bgray-200 dark:border-darkblack-400">
                  ...
                  >
                    ...
                    <span className=" w-5 h-5 bg-success-50 inline-flex justify-center items-center text-success-300 rounded-full text-[10px]">
                      0
                    </span>
                  </button>
                </div>
                <ul className="w-full min-h-[100px] overflow-y-scroll scroll-style-1">
                  {/* <li className="py-6 px-7 hover:bg-bgray-100 dark:hover:bg-darkblack-500 border-b border-bgray-200 dark:border-darkblack-400">
                    <a href="#">
                      <div className="flex space-x-3">
                        <div className="w-[48px] h-[48px] rounded-full relative">
                          ...
                          />
                          <div className="w-3 h-3 rounded-full bg-bgray-300 border border-white absolute bottom-0 right-0" />
                        </div>
                        <div className="flex-1">
                          <p className="font-bold text-base text-bgray-900 dark:text-white mb-1">
                            James Eusobio
                          </p>
              ...
              <div className="w-full h-[75px] flex justify-between items-center absolute left-0 bottom-0 px-8">
                <div>
                  <a href="#">
                    <div className="flex space-x-2 items-center">
                      <span>
        ...
        <div className="store-wrapper">
          ...
          <div
            ...
            className="w-[330px] overflow-hidden bg-white dark:bg-darkblack-600 absolute -left-[134px] top-[81px] rounded-lg hidden"
          >
            <div className="w-full p-6 relative">
              <div className="bonus-box-wrapper overflow-hidden w-full pb-[33px]">
                <div className="bonus-box w-full flex justify-center relative">
                  <div
                    style={{ width: 'calc(100% - 20px)' }}
                    className="absolute left-[10px] top-[5px] h-[200px] bg-success-200 rounded-lg"
                  />
                  <div className="w-full p-5 bg-success-400 rounded-lg relative">
                    ...
                    <p className="text-lg font-semibold text-success-100 leading-[24px] text-center px-5 mb-3">
                      AI Computed Budget Operational Health.
                    </p>
                    <div className="flex justify-center">
                      <a href="#">
                        <div className="w-[166px] h-[56px] flex justify-center items-center rounded-lg bg-warning-300 hover:bg-warning-200 transition duration-300 ease-in-out">
                          <span className="text-bgray-900 text-md font-bold">
                            Discover More
                          </span>
                        </div>
                      </a>
              ...
              <BudgetAiScore score={0} size={80} />
              <p className="text-md font-semibold text-red-400 dark:text-yellow-100 text-center mb-2.5">
                Your MDA BOH is{' '}
                <strong className="text-lg font-semibold text-success-300 text-center mb-2.5">
                  0%
                </strong>
              </p>
            </div>
        ...
        <div className="profile-wrapper">
          ...
          <div
            ...
            className="profile-box w-[300px] overflow-hidden bg-white dark:bg-darkblack-600 absolute right-0 top-[81px] rounded-lg hidden"
          >
            <div className="w-full px-3 py-2 relative">
                ...
                <ul>
                  <li className="w-full">
                    <a href="settings.html">
                      <div className="flex space-x-[18px] items-center p-[14px] hover:bg-bgray-100 hover:dark:bg-darkblack-500  rounded-lg text-bgray-600 hover:text-bgray-900">
                  ...
                  <li className="w-full">
                    <a href="messages.html">
                      <div className="flex space-x-[18px] items-center p-[14px] hover:bg-bgray-100 dark:hover:bg-darkblack-500 rounded-lg dark:text-bgray-300 text-bgray-600 hover:text-bgray-900">
                        <div className="w-[20px]">
                          <span>
                            <svg
              ...
              <div>
                <ul>
                  <li className="w-full">
                    <a href="settings.html">
                      <div className="p-[14px] hover:bg-bgray-100 dark:hover:bg-darkblack-500 rounded-lg text-bgray-600 dark:text-bgray-50 hover:text-bgray-900">
