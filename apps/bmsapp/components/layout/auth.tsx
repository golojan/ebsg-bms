    ...
    <>
      ...
      <div>
            ...
            <div className="lg:w-1/2 px-5 xl:pl-12 pt-10">
              ...
              <div className="max-w-[450px] m-auto pt-24 pb-16">
                ...
                <nav className="flex items-center justify-center flex-wrap gap-x-11 pt-24">
                  <a
                    href="#"
                    className="text-sm text-bgray-700 dark:text-white"
                  >
                    Terms &amp; Condition
                  </a>
                  <a
                ...
                <p className="text-bgray-600 dark:text-white text-center text-sm mt-6">
                  @ 2023 Ebonyi State Government. All Right Reserved.
                </p>
              </div>
            </div>
            {/* Right */}
              ...
              <div>
                <div className="text-center max-w-lg px-1.5 m-auto">
                  ...
                  <p className="text-bgray-600 dark:text-bgray-50 text-sm font-medium">
                    ...
                    days early. Get a
                    <span className="text-success-300 font-bold">$20</span>{' '}
        ...
        <div
          ...
          id="multi-step-modal"
        >
          <div className="modal-overlay absolute inset-0 bg-gray-500 opacity-75 dark:bg-bgray-900 dark:opacity-50" />
