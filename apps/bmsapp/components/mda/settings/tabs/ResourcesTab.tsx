  ...
  return (
    <>
      <div className="grid grid-cols-12">
        <div className="2xl:col-span-9 col-span-12 2xl:border-r border-bgray-300">
          ...
          <div className="pt-7 border-t border-bgray-300 mt-8">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="switch-btn text-center bg-gray-200 relative inline-flex h-2/5 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-0"
                  role="switch"
                  aria-checked="false"
                  aria-labelledby="availability-label"
                  aria-describedby="availability-description"
