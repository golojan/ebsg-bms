...
const AddFile = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center border-dashed border-2 border-bgray-300 dark:border-success-300 rounded-lg md:w-32 md:h-32 w-24 h-24 lg:w-44 lg:h-44 mx-3">
