...
export const Integration = () => {
  return (
    <>
      <div className="grid lg:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-3 lg:gap-4 xl:gap-6">
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/stack_overflow.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
          ...
          <button className="text-base w-full text-success-300 font-medium h-12 rounded-md border border-success-300 hover:text-white hover:bg-success-300 transition duration-300 ease-in-out">
            Connect
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/ms_excel.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
          ...
          <button className="text-base w-full text-bgray-600 h-12 rounded-md border border-bgray-600 hover:text-white bg-white hover:bg-bgray-600 transition duration-300 ease-in-out dark:bg-darkblack-600 dark:text-bgray-300">
            Disconnect
          </button>
        </div>
        {/* Single Integration Disconnect*/}
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/trello.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/google_meet.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/dropbox.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/wordpress.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/facebook.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/twitter.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/youtube.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
        ...
        <div className="bg-white dark:bg-darkblack-600 rounded-lg p-6 relative">
          ...
          <div className="flex space-x-5">
            <div className="shrink-0">
              <img
                src="assets/images/integrations/tik-tok.svg"
                alt="Stack Overflow"
              />
            </div>
            <div>
